package com.uniah.mobile.imagebrowserlibrary.model;
...
import com.uniah.mobile.imagebrowserlibrary.R;
...
public class ImageBrowserConfig {
    ...
    //打开动画
    private boolean isOpenAnimDefault = true;
    //打开动画
    @AnimRes
    private int activityOpenAnim = R.anim.mn_browser_enter_anim;
    //关闭动画
    @AnimRes
    private int activityExitAnim = R.anim.mn_browser_exit_anim;

    public int getActivityOpenAnim() {
        return activityOpenAnim;
    }

    public void setActivityOpenAnim(@AnimRes int activityOpenAnim) {
        this.activityOpenAnim = activityOpenAnim;
        isOpenAnimDefault = false;
    }

    public int getActivityExitAnim() {
        return activityExitAnim;
    }

    public void setActivityExitAnim(@AnimRes int activityExitAnim) {
        this.activityExitAnim = activityExitAnim;
    }

    public boolean isOpenAnimDefault() {
        return isOpenAnimDefault;
    }

    public void setOpenAnimDefault(boolean openAnimDefault) {
        isOpenAnimDefault = openAnimDefault;
    }
