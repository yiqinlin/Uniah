...
import com.uniah.mobile.imagebrowserlibrary.transforms.DefaultTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.DepthPageTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.RotateDownTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.RotateUpTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.ZoomInTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.ZoomOutSlideTransformer;
import com.uniah.mobile.imagebrowserlibrary.transforms.ZoomOutTransformer;
import com.uniah.mobile.imagebrowserlibrary.utils.StatusBarUtil;
import com.uniah.mobile.imagebrowserlibrary.view.CircleIndicator;
import com.uniah.mobile.imagebrowserlibrary.view.MNGestureView;
import com.uniah.mobile.imagebrowserlibrary.view.MNViewPager;
...
public class MNImageBrowserActivity extends AppCompatActivity {
    ...
    private void finishBrowser() {
        try {
            ...
            rl_indicator.setVisibility(View.GONE);
            finish();
            this.overridePendingTransition(0, imageBrowserConfig.getActivityExitAnim());
            //销毁相关数据
            sActivityRef = null;
