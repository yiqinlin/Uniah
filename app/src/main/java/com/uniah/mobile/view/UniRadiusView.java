...
public class UniRadiusView extends AppCompatImageView implements IQMUILayout {
    ...
    public UniRadiusView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public UniRadiusView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UniRadiusView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.UniRadiusView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.UniRadiusView_uni_borderWidth, 0);
        mBorderColor = array.getColor(R.styleable.UniRadiusView_uni_borderColor, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(R.styleable.UniRadiusView_uni_selectedBorderWidth, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.UniRadiusView_uni_selectedBorderColor, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.UniRadiusView_uni_selectedMaskColor, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.UniRadiusView_uni_isTouchSelectModeEnabled, true);
        mIsCircle = array.getBoolean(R.styleable.UniRadiusView_uni_isCircle, false);
        if (!mIsCircle) {
            setRadius(array.getDimensionPixelSize(R.styleable.UniRadiusView_uni_cornerRadius, 0));
        }
        array.recycle();
    }
