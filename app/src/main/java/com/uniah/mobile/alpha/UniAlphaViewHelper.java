...
public class UniAlphaViewHelper {
    ...
    public UniAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = UniResHelper.getAttrFloatValue(target.getContext(), R.attr.uni_alpha_pressed);
        mDisabledAlpha = UniResHelper.getAttrFloatValue(target.getContext(), R.attr.uni_alpha_disabled);
    }

    public UniAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
