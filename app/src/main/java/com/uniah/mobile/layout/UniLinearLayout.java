...
import com.uniah.mobile.alpha.UniAlphaLinearLayout;

public class UniLinearLayout extends UniAlphaLinearLayout implements IUniLayout {
    private UniLayoutHelper mLayoutHelper;

    public UniLinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public UniLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UniLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
