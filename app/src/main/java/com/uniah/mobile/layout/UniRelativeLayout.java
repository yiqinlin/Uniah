...
import com.uniah.mobile.alpha.UniAlphaRelativeLayout;

public class UniRelativeLayout extends UniAlphaRelativeLayout implements IUniLayout {
    private UniLayoutHelper mLayoutHelper;

    public UniRelativeLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public UniRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UniRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new UniLayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @UniLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @UniLayoutHelper.HideRadiusSide int hideRadiusSide) {
