...
import com.uniah.mobile.alpha.UniAlphaFrameLayout;

public class UniFrameLayout extends UniAlphaFrameLayout implements IUniLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new UniLayoutHelper(context, attrs, 0, this);
