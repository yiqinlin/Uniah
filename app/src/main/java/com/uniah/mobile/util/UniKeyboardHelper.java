...
public class UniKeyboardHelper {
    /**
     * 显示软键盘的延迟时间
     */
    public static final int SHOW_KEYBOARD_DELAY_TIME = 200;
    private static final String TAG = "UniKeyboardHelper";
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            UniDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        int visibleThreshold =
                Math.round(UniDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
