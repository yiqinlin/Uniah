    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                UniLog.printErrStackTrace(TAG, e, "read file error");
            } finally {
                UniLangHelper.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            UniLog.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }
